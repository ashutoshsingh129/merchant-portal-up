...
const Dashboard: React.FC = () => {
    ...
    const fetchVolumeData = useCallback(async () => {
        try {
            ...
            const response = await stripeService.getVolumeData({
                days: selectedDays,
                groupBy: selectedDays === 1 ? 'hour' : 'day',
            });
    ...
    const formatXAxisLabel = (time: string) => {
        const groupBy = selectedDays === 1 ? 'hour' : 'day';
                    ...
                    <ChartCardContent>
                        ...
                        {loading ? (
                            ...
                            >
                                ...
                                >
                                    No volume data available for the selected
                                    period
                                </Typography>
                            </Box>
                        ) : (
