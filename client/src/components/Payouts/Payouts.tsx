                ...
                if (dateFilterType === 'in_last' && dateFilterDays) {
                    ...
                    filtered = filtered.filter(payout => {
                        ...
                        switch (dateFilterType) {
                            case 'equal_to':
                                return (
                                    payoutDate >= filterTimestamp &&
                                    payoutDate <= filterTimestampEnd
                                );
                            case 'on_or_after':
                                return payoutDate >= filterTimestamp;
                            case 'before_or_on':
                                return payoutDate <= filterTimestampEnd;
                            case 'between':
                                if (dateFilterInput2) {
